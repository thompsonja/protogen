...
type ExampleClient interface {
	SomeFunc(ctx context.Context, in *SomeRequest, opts ...grpc.CallOption) (*SomeReply, error)
}
...
func (c *exampleClient) SomeFunc(ctx context.Context, in *SomeRequest, opts ...grpc.CallOption) (*SomeReply, error) {
	out := new(SomeReply)
	err := c.cc.Invoke(ctx, "/example.Example/SomeFunc", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	SomeFunc(context.Context, *SomeRequest) (*SomeReply, error)
...
func (UnimplementedExampleServer) SomeFunc(context.Context, *SomeRequest) (*SomeReply, error) {
...
func _Example_SomeFunc_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SomeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExampleServer).SomeFunc(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/example.Example/SomeFunc",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).SomeFunc(ctx, req.(*SomeRequest))
	}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SomeFunc",
			Handler:    _Example_SomeFunc_Handler,
		},
	},
